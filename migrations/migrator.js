...
const roles = [{ name: "admin" }, { name: "employee" },{name:"user"}];

const addRoles = async () => {
  let result = await roleDB.findOne({ name: "admin" });
  if (result) {
